...
namespace Module.EventManager
{
	...
	{
		private readonly Dictionary<uint,NoArgEvent> _noArgEvents = new Dictionary<uint, NoArgEvent>(256);
		
		// 多人协助的话，需要注意对Object做约束。
		private readonly Dictionary<uint,object> _argEvents = new Dictionary<uint,object>(256);
